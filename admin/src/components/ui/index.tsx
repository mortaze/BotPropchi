...
export function Button({ children, variant = "primary", size = "md", className, loading, ...props }: {
  ...
  return (
    <button className={cn("inline-flex min-h-10 items-center justify-center gap-2 rounded-lg font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed", btnStyles[variant], sizeClass, className)}
...
export function Modal({ open, onClose, title, children, size = "md" }: {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className={cn("relative flex max-h-[calc(100dvh-2rem)] w-full flex-col overflow-hidden bg-card border border-border rounded-2xl shadow-2xl animate-fade-in", sizeClass)}>
